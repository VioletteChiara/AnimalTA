...
from AnimalTA import Interface_masking, Interface_scaling, UserMessages, Interface_extend, \
...
class Row_Can(Canvas):
    ...
    def check_stab(self):
        ...
        self.main_frame.Change_win(Interface_stabilis.Stabilise(parent=self.main_frame.canvas_main, boss=self, main_frame=self.main_frame, Video_file=self.Video))
