...
import csv
import os
from AnimalTA import Interface_masking, Class_stabilise, UserMessages, Interface_back, Class_Lecteur, Interface_parameters_track, Do_the_track3
...
class Show(Frame):
    ...
    def load_coos(self):
        #Load the coordinates corresponding to the portion to be corrected
        self.Coos={}
    ...
    def modif_image(self, img=[], aff=False, move=True, *args):
