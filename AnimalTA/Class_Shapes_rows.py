...
import numpy as np
import cv2
from AnimalTA import Function_draw_mask, UserMessages
import time

#This file contains classes herited from Frame. It is Frames widgets which will show the characteristics of an element of interest (in the Analyses part) and allow to modify or delete it.
