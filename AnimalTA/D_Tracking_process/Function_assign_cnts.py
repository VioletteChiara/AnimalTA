...
def Treat_cnts_fixed(Vid, Arenas, start, prev_row, Extracted_cnts, Too_much_frame, Th_extract_cnts, To_save, portion, one_every, AD):
...
def Treat_cnts_variable(Vid, Arenas, Main_Arenas_Bimage, start, prev_row, Extracted_cnts, Too_much_frame, Th_extract_cnts, To_save, portion, one_every, AD):
